...
- **Machine Learning Intern** — *Tendworks Pvt. Ltd.* (Mar 2026 – Present)
  - HRMS Expense Management module: data handling and workflow logic within an enterprise HR management system.
- **Machine Learning Intern** — *OEG Defence & Aerospace Pvt. Ltd.* (Jun 2025)
  - AI-powered drone vision systems, YOLOv8 object detection, Roboflow dataset pipelines, and OpenCV edge camera inference.
